...
"""
Funcion para leer el catalogo de programas validos de la radio
de un archivo csv que contienen el nombre del programa
y el conductor.
...
def leer_catalogo_programas(RUTA_A_CATALOGO: Path):
    ...
    print("Aviso: no hay un catalogo de programas")
    return {}
